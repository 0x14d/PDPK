...
class QuantifiedParametersWithShortcut2(KnowledgeGraphGenerator, QP_super):
    """
    Class that provides functionality to generate knowledge graphs that display
    a quantified parameters like relations including a high level pq-relation.
    ...
    def generate_knowledge_graph(self) -> Graph:
        return QP_super.generalized_generate_knowledge_graph(
            self, with_shortcut=True, flip_quantified_by=True
        )

...
class TrialExperimentSeriesGeneratorConfig(AbstractExperimentSeriesGeneratorConfig):
    ...
    override_expert_knowledge: bool = False
    """
    If True the pq-relations found during the trial process override the generated expert knowledge.
    If False the expert knowledge generated by the PQTuplGenerator isn't adjusted.
    """
